...
ft_setup_util.c ft_isdigit.c ft_setmap.c ft_strlen.c ft_strdup.c ft_strtrim.c ft_toupper.c
...
ft_setup_util.o ft_isdigit.o ft_setmap.o ft_strlen.o ft_strdup.o ft_strtrim.o ft_toupper.o
