...
ft_setup_util.c ft_isdigit.c ft_setmap.c ft_strlen.c ft_strdup.c ft_strtrim.c ft_toupper.c ft_tolower.c ft_utils.c ft_strncmp.c
...
ft_setup_util.o ft_isdigit.o ft_setmap.o ft_strlen.o ft_strdup.o ft_strtrim.o ft_toupper.o ft_tolower.o ft_utils.o ft_strncmp.o
